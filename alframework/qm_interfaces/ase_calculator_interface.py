...
def ase_calculator_task(configuration,molecule_id,atoms,calculator,directory,command,properties=['energy','forces']):
    ...
    module_string = '.'.join(calculator.split('.')[:-1])
    class_string = calculator.split('.')[-1]
