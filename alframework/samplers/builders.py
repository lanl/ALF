...
from moltensalt_builder import atomic_system_builder
...
def atomic_system_task(atom_charges, target_num_atoms, min_distance, box_length_range, moleculeid):
    ...
    Returns:
        (tuple): tuple of a list containing a dict indicating the unique identifier of the system, an ASE Atoms
                 object, and an empty dict.
    """
