    ...
    executors=[
        ...
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                # string to prepend to #SBATCH blocks in the submit
                scheduler_options='#SBATCH --ntasks-per-node=128 --nodes=1 -A w23_ml4chem --qos=standby --time-min=00:10:00',
        ...
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                scheduler_options='#SBATCH --nodes=1 -p gpu -A  g23_slic2023_g',
        ...
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                # string to prepend to #SBATCH blocks in the submit
                #scheduler_options='#SBATCH --qos=debug',
                scheduler_options='#SBATCH --nodes=1 -p gpu -A  g23_slic2023_g --qos=standby --time-min=00:10:00',
    ...
    executors=[
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                # string to prepend to #SBATCH blocks in the submit
                scheduler_options='#SBATCH --ntasks-per-node=128 --nodes=1 -A w23_ml4chem --qos=debug --reservation=debug',
