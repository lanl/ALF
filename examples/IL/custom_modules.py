    ...
    executors=[
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                scheduler_options='#SBATCH -A w23_ml4chem',
        ...
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                # string to prepend to #SBATCH blocks in the submit
                scheduler_options='#SBATCH -A w23_ml4chem --qos=standby --time-min=00:45:00',
    ...
    executors=[
        HighThroughputExecutor(
            ...
            provider=SlurmProvider(
                ...
                # string to prepend to #SBATCH blocks in the submit
                scheduler_options='#SBATCH -A w23_ml4chem --qos debug --reservation debug',
